...
mainRouter.use('/stats', stats_router_1.default);
mainRouter.use('/shipping', shipping_route_1.default);
mainRouter.use('/settings', [onlyAdmin_1.default], settings_route_1.default);
